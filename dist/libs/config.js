...
exports.convertToMongoDbId = exports.SECRET_TOKEN = exports.MORGAN_STANDARD = exports.AUTH_TIME = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
exports.AUTH_TIME = 48;
exports.MORGAN_STANDARD = `:method :url :response-time :status \n`;
exports.SECRET_TOKEN = process.env.SECRET_TOKEN || "default_secret_token";
